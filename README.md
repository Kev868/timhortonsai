...
- *Also worth knowing:* originally targeted OpenAI fine-tuning, but they're sunsetting self-serve mid-2026. Pivoted to Together. The pivot is itself a signal: the platform landscape shifts fast.
...
Unfortunately I could not obtain further Llama stats due to me running out of money to host it (at around $1 per minute). Another thing I would do next is test the fine-tuned model's parameters after training to see if they match what was intended before spending the inference budget.
